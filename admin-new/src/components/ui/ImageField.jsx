/**
 * @fileoverview Image upload field. Same pipeline as the legacy admin:
 * POST /media/upload (multipart) → store the normalised relative path.
 */
...
export default function ImageField({ label, value, onChange, required, help }) {
